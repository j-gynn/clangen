...
def handle_grief(dead_cat: "Cat", body: bool):
    """
    compiles grief moon event text
    :param dead_cat: The cat that has just perished
    :param body:
    """
    if body:
        body_status = "body"
    ...
    for cat in Cat.all_cats.values():
        ...
        family_relation = dead_cat.familial_grief(living_cat=cat)
        very_high_types = []
        high_types = []
        very_low_types = []
    ...
    game.dead_cats_to_grieve.append(dead_cat)
